...
const PropertyDetails1 = (props,{id}) => {
  const initialRating = 3; // Initial rating value
  const [rating, setRating] = React.useState(initialRating); // State to manage the rating

  // Function to handle rating changes
  const handleRatingChange = (newRating) => {
    setRating(newRating); // Update the rating state when the rating changes
  };
    ...
    <div className={styles["property-details"]}>
      ...
      <span className={styles["text15"]}>
        <span>
          ...
          <br></br>
          <span>Cairo, New Cairo City, South</span>
          <br></br>
